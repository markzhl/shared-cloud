  ...
  protected void configure(HttpSecurity http) throws Exception {
    http.formLogin().loginPage("/login").defaultSuccessUrl("/admin/index").permitAll().and()
        ...
        .antMatchers("/**/*.css", "/img/**", "/**/*.js",
        	"/apiauth/**","/apisec/**","/*/apisec/**",
        	"/api/**","/metrics/**","/env/**","/beans","/configprops","/mappings","/info","/health","/dump","/refresh","/heapdump","/restart","/pause","/resume","/features","/trace","/autoconfig") // 放开"/api/**",通过oauth2.0来鉴权
